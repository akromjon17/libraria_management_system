...
import librarianapp.model.Book;
...
{
    public Pane root ;
    public Label header, titleLbl, authorLbl, isbnLbl, publisherLbl, categoryLbl, totalCopiesLbl, copiesAvailableLbl ;
    ...
    private String generateID(String firstName, String lastName)
    {
        ...
        //{
            ...
            id = id.concat(num) ;
        //}
       // while(dataBaseController.getFromBooks(id,  "Title") != null) ;
