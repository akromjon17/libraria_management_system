...
public class SignInPageController implements Initializable
{
    ...
    private void signIn(Event e)
    {
        ...
        else
        {
            ...
            Main.userAccount = dataBaseController.signInToAcct("LIBRARIAN", usernameField.getText(), passwordField.getText()) ;
    ...
    private void loadHomePage(Event event)
    {
        try
        {
            ...
            stage.getIcons().add(new Image("/librarianapp/resources/images/books.png"));
