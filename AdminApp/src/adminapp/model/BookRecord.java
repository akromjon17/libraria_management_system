...
{
    private adminapp.model.Book book ;
    ...
    public BookRecord(adminapp.model.Book book, String refNum, String accountID, String accountType, String dateOfReservation, String dateOfCancellation, String dateOfIssue, String dateDue, String dateOfRequestToReturn, String dateOfReturn)
    {
        this.book = book;
        this.refNum = refNum ;
    ...
    public BookRecord(adminapp.model.Book book, String refNum, String accountID, String accountType)
    {
        this.book = book ;
        this.refNum = refNum ;
        this.accountID = accountID ;
    ...
    public BookRecord(adminapp.model.Book book, String accountID, String acctType) {
        this.book = book ;
        this.accountID = accountID ;
    ...
    public adminapp.model.Book getBook() {
        return book;
    }

    public void setBook(adminapp.model.Book book) {
        this.book = book;
    }
