...
public class SignInPageController extends Main implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        try
        {
            ...
            signInBtn.setId("signInButton_style");
    ...
    private void signIn(Event event)
    {
        ...
        if(!usernameField.getText().isEmpty() && !passwordField.getText().isEmpty())
        {
            ...
            Main.userAccount = dataBaseController.signInToAcct("ADMIN", usernameField.getText(),passwordField.getText() ) ;
